...
INPUT_NODE = 784   # 输入节点
OUTPUT_NODE = 10   # 输出节点
LAYER1_NODE = 500  # 每个隐藏层的节点数
BATCH_SIZE = 100   # 每次训练的样本个数，BATCH_SIZE越小越接近随机梯度下降，越大就越接近梯度下降
...
def train(mnist):
    ...
    variables_averages_op = variable_averages.apply(tf.trainable_variables()) # tf.trainable_variables()所有变量都会更新
